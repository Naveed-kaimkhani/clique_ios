    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Text("Verification code", style: TextStyle(color: Colors.white, fontSize: 24, fontWeight: FontWeight.bold)),
            SizedBox(height: 10),
            Text("Enter OTP sent to your phone", style: TextStyle(color: Colors.grey, fontSize: 16)),
            SizedBox(height: 20),
            ...
            PinCodeTextField(
              ...
              pinTheme: PinTheme(
                ...
                fieldHeight: 50,
                fieldWidth: 40,
                inactiveFillColor: Color(0xFF161622),
                inactiveColor: Colors.grey.shade700,
                ...
                child: Container(
                  decoration: BoxDecoration(
                    gradient: LinearGradient(
                      colors: [Color(0xFF6A5AE0), Color(0xFF947BFB)],
