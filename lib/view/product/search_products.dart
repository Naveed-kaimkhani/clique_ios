  ...
  Future<void> fetchProducts(String searchQuery) async {
    ...
    try {
      final response = await http.get(
        ...
        headers: {
          'Authorization':
              'Bearer ${userController.token.value}', // Pass the token in the Authorization header
        },
      );
              ...
              decoration: InputDecoration(
                ...
                focusedBorder: OutlineInputBorder(
                  ...
                  borderSide: BorderSide(
                      color: Colors.grey,
                      width: 1), // Set focus border color to grey
                ),
              ),
              onChanged: (value) {
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return GestureDetector(
                          ...
                          onTap: () {
                            ...
                            // Wait for keyboard to close (a small delay helps)
                                          ...
                                          child: Text(
                                            ...
                                            style: TextStyle(
                                              ...
                                              overflow: TextOverflow
                                                  .ellipsis, // Ensure that text is truncated with an ellipsis
                                            ),
                                          ),
                                        ),
                                      )
