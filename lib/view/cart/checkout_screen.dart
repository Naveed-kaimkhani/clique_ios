...
// final CartQuantityController _cartQuantityController = Get.find<CartQuantityController>();
      ...
      body: Column(
        ...
        children: [
          ...
          Padding(
            padding: EdgeInsets.only(
                right: horizontalPadding, left: horizontalPadding),
            child: cartItemList(cartItemSize),
          ),
          Spacer(),
    ...
    return Obx(() => ListTile(
          onTap: () {
            if (addressController.address1.value.isEmpty) {
              ...
              // orderController.submitOrderFromCart();
            }
          },
  ...
  Widget cartItemList(double size) {
    return Obx(() => SizedBox(
          height: size, // height of each card
          child: ListView.builder(
            scrollDirection: Axis.horizontal,
            itemCount: _cartQuantityController.products.length,
            itemBuilder: (context, index) {
              final product = _cartQuantityController.products[index];
              return Container(
                width: size + 220, // Adjust width to fit image + text
