    ...
    return SafeArea(
      ...
      child: Scaffold(
        ...
        body: Obx(() {
          ...
          final product = _productViewModel.products
              .firstWhereOrNull((e) => e.id.toString() == uid);
...
//   void initState() {
//     super.initState();
//     final localProduct = _productViewModel.products.firstWhereOrNull((e) => e.id.toString() == uid);
//     if (localProduct != null) {
//       cartQuantityController.products.add(localProduct);
//       futureProduct = Future.value(localProduct);
//     } else {
//       futureProduct = _productViewModel.fetchProductById(int.parse(uid));
//     }
//   }
...
//               if (!cartQuantityController.products.any((p) => p.id == product.id)) {
//                 cartQuantityController.products.add(product);
//               }
...
//                         Obx(() => SummaryRow(
//                               title: "Sub Total",
//                               amount: (product.cost) * cartQuantityController.quantity.value,
//                               isBold: true,
//                             )),
//                         const SizedBox(height: 60),
//                         AuthButton(
