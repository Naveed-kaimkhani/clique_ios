...
//   // Dispose all active streams when view model is disposed
//   @override
//   void onClose() {
...
//   final Map<String, StreamController<Map<String, int>>> _reactionControllers = {};
//   final Set<String> startedStreams = {};
//   final Map<String, String> _userReactionMap = {}; // key = "$messageId:$uid", value = reaction
...
//   Future<void> toggleReaction(String messageId, String selectedReaction, int uid) async {
//     final userKey = "$messageId:$uid";
//     final previousReaction = _userReactionMap[userKey];

//     if (previousReaction == selectedReaction) {
//       // Same emoji pressed again — remove it
//       await removeReactionFromMessage(messageId, selectedReaction, uid);
//     } else {
//       // Remove old reaction (if any)
//       if (previousReaction != null) {
//         await removeReactionFromMessage(messageId, previousReaction, uid);
//       }
//       // Add new one
//       await addReactionToMessage(messageId, selectedReaction, uid);
//     }
...
//       );
//       if (response.statusCode == 200 || response.statusCode == 201) {
//         _userReactionMap["$messageId:$uid"] = reaction;
//       } else {
//         Get.snackbar('Error', 'Failed to add reaction');
//       }
//     } catch (e) {
...
//       );
//       if (response.statusCode == 200 || response.statusCode == 204) {
//         _userReactionMap.remove("$messageId:$uid");
//       } else {
//         Get.snackbar('Error', 'Failed to remove reaction');
//       }
//     } catch (e) {
...
//             _userReactionMap["$messageId:$uid"] = emoji;
//             grouped[emoji] = (grouped[emoji] ?? 0) + 1;
//           }
//         }
