...
class GroupAppBar extends StatelessWidget {
  ...
  final int uid;
   ...
   GroupAppBar({super.key,required this.guid, required this.uid, required this.title, required this.memberCount , this.profile});
...
Expanded(
  child: Align(
    ...
    child: IconButton(icon: Icon(Icons.logout),onPressed: ()=> _showDeleteAccountDialog(context), color: Colors.white,),
      ),
    ),
  ),
),
