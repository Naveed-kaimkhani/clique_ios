...
//                               },
//                               child: Obx(()=>Text(
//                                 widget.isJoin ? "Message" : groupController.isJoining.value?"Joining...": "Join Now",
//                                 style: TextStyle(
//                                   color: Colors.white,
...
//   final bool isJoin;
//   const JoinButtonText({required this.isJoin});
...
//     return Obx(() {
//       return Text(
//         isJoin ? "Message" : groupController.isJoining.value ? "Joining..." : "Join Now",
//         style: TextStyle(
//           color: Colors.white,
      ...
      widget.isJoin?Text(
          ...
          style: TextStyle(
            ...
            fontSize: size.width * 0.032,
                        ...
                        //         }
                        //       },
                        //       child: JoinButtonText(isJoin: widget.isJoin),
                        //     ),
                        //   ),
                        // ),
                      ],
